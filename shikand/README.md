...
Сначала я сделала его **только для себя**. Надоело покупать красивые блокноты и почти не писать в них — жалко страницы, страшно «написать не так». Хотелось одно спокойное и красивое место, где можно фиксировать день, цели, деньги, привычки и мысли, не чувствуя, что сдаёшь отчёт.
...
> Сюда лучше вставить 3–5 своих скринов (главная, деньги, привычки, хотелки).  
...
Из имени и пароля собирается служебный email для Supabase. Тебе не нужно помнить настоящий email — только своё имя и эти 4 символа.
...
**SHIKAND?** — место, где можно просто быть.  
Данные в облаке, давление — нет.
